...
export const getWallOfArticlesData = (state: StateSchema) =>
  state.wallOfArticles?.data || EMPTY_ARRAY;
...
export const getWallOfArticlesHasMore = (state: StateSchema) =>
  Boolean(state.wallOfArticles?.hasMore);

export const getWallOfArticlesSort = (state: StateSchema) =>
  state.wallOfArticles?.sort || ArticleSortedField.CREATED_AT;

export const getWallOfArticlesOrder = (state: StateSchema) =>
  state.wallOfArticles?.order || 'asc';

export const getWallOfArticlesSearch = (state: StateSchema) =>
  state.wallOfArticles?.search ?? '';
...
export const getWallOfArticlesLoading = (state: StateSchema) =>
  Boolean(state.wallOfArticles?.isLoading);
